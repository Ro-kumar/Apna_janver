...
public final class WishlistRvBinding implements ViewBinding {
  @NonNull
  ...
  private WishlistRvBinding(@NonNull LinearLayout rootView, @NonNull ImageView addWishlist,
      @NonNull TextView address, @NonNull CardView card, @NonNull ImageView img,
  ...
  @NonNull
  public static WishlistRvBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static WishlistRvBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.wishlist_rv, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static WishlistRvBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new WishlistRvBinding((LinearLayout) rootView, addWishlist, address, card, img, name,
          service);
    }
